        ...
        <tr>
            <td align="center" style="padding: 20px;">
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow:hidden; box-shadow:0 2px 8px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td align="center" style="padding: 20px;">
                            <a href="{{ rtrim(config('app.frontend_url'), '/') }}/{{ ltrim('Cotizacion/'.$cotizacion->id, '/') }}" style="display:inline-block; background-color:#007bff; color:#ffffff; text-decoration:none; padding:12px 24px; border-radius:4px; font-weight:bold;">
